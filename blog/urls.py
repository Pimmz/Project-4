...
urlpatterns = [
    ...
    path("update_adoption/<int:pk>/", views.AdoptionUpdateView.as_view(), name='update_adoption'),
    path("delete_adoption/<int:pk>/", views.DeleteAdoptionView.as_view(), name='delete_adoption'),
    path("rehome/<int:pk>/", views.RehomeDetailView.as_view(), name='rehome_detail'),
    path("update_rehome/<int:pk>/", views.RehomeUpdateView.as_view(), name='update_rehome'),
    path("delete_rehome/<int:pk>/", views.DeleteRehomeView.as_view(), name='delete_rehome'),
